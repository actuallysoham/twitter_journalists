...
if chart_select == 'Scatterplots':
    ...
    st.write('The polarity scores are calculated by a simple ratio of RTs received by a journalist from politicians and their affiliations. Tweets were collected over a period starting from 1st August 2021 to 14th September 2022. Please refer to XYZ for additional details on the data collection process, methodology and interpretation.')
